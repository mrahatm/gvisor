...
var AMD64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		9:   syscalls.PartiallySupported("mmap", Mmap, "Doesn't currently implement MAP_GROWSDOWN or MAP_HUGETLB.", nil),
		...
		26:  syscalls.PartiallySupported("msync", Msync, "???", nil),
		27:  syscalls.PartiallySupported("mincore", Mincore, "Stub implementation. The sandbox does not have access to this information.", nil),
		28:  syscalls.PartiallySupported("madvise", Madvise, "Stub implementation. The sandbox does not have access to this information.", nil),
		29:  syscalls.Supported("shmget", Shmget),
		30:  syscalls.Supported("shmat", Shmat),
		31:  syscalls.Supported("shmctl", Shmctl),
		...
		41:  syscalls.Supported("socket", Socket),
		...
		56:  syscalls.PartiallySupported("clone", Clone, "Not all namespaces and options are supported.", nil),
		...
		87:  syscalls.Supported("link", Unlink),
		...
		98:  syscalls.Supported("getrusage", Getrusage),
		99:  syscalls.PartiallySupported("sysinfo", Sysinfo, "Not all keys are supported.", nil),
		100: syscalls.Supported("times", Times),
		101: syscalls.PartiallySupported("ptrace", Ptrace, "Not every option is implemented.", nil),
		102: syscalls.Supported("getuid", Getuid),
		103: syscalls.Supported("syslog", Syslog),
		...
		133: syscalls.PartiallySupported("mknod", Mknod, "Device creation is not generally supported.", nil),
		...
		158: syscalls.PartiallySupported("arch_prctl", ArchPrctl, "Not all options are supported.", nil),
		159: syscalls.CapError("adjtimex", linux.CAP_SYS_TIME, "", nil),
		160: syscalls.Supported("setrlimit", Setrlimit),
		...
		202: syscalls.Supported("futex", Futex),
		...
		206: syscalls.PartiallySupported("io_setup", IoSetup, "Not user ring is not implemented.", nil),
		207: syscalls.PartiallySupported("io_destroy", IoDestroy, "Not user ring is not implemented.", nil),
		208: syscalls.PartiallySupported("io_getevents", IoGetevents, "Not user ring is not implemented.", nil),
		209: syscalls.PartiallySupported("io_submit", IoSubmit, "Not user ring is not implemented.", nil),
		210: syscalls.PartiallySupported("io_cancel", IoCancel, "Not user ring is not implemented.", nil),
		...
		272: syscalls.PartiallySupported("unshare", Unshare, "Not all namespaces are supported.", nil),
